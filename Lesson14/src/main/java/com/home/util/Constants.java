...
public class Constants {
    ...
    public static final String INPUT_FILE_1 = RESOURCE_DIR + "/hw1/input.txt";
    public static final String OUTPUT_FILE_1 = RESOURCE_DIR + "/hw1/output.txt";
    public static final String INPUT_FILE_2 = RESOURCE_DIR + "/hw2/input.txt";
